...
class helperFunctions(ScriptedLoadableModuleLogic):
    ...
    def radialDose(self, fid, doseMap,IjktoRasMatrix,originalPointinRAS):
    ...
    def calcDoseRadius(self):
        ...
        for i in range(num):
            ...
            self.radialDose(p_IJK[0:3], doseMap,IjktoRasMatrix,originalPointinRAS)
